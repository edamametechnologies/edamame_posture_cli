_edamame_posture() {
    ...
    do
        case "${cmd},${i}" in
            ...
            edamame_posture,augment-custom-whitelists)
                ...
                ;;
            edamame_posture,background-agentic-summary)
                cmd="edamame_posture__background__agentic__summary"
                ;;
            ...
            edamame_posture__help,augment-custom-whitelists)
                ...
                ;;
            edamame_posture__help,background-agentic-summary)
                cmd="edamame_posture__help__background__agentic__summary"
                ;;
    ...
    case "${cmd}" in
        ...
        edamame_posture__augment__custom__whitelists)
            ...
            return 0
            ;;
        edamame_posture__background__agentic__summary)
            opts="-v -h --verbose --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        edamame_posture__help__augment__custom__whitelists)
            ...
            return 0
            ;;
        edamame_posture__help__background__agentic__summary)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
