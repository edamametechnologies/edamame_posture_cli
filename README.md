...
- name: Setup EDAMAME Posture
  run: |
    ...
    curl -LO https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-x86_64-unknown-linux-gnu
    chmod +x edamame_posture-0.9.47-x86_64-unknown-linux-gnu
    sudo mv edamame_posture-0.9.47-x86_64-unknown-linux-gnu /usr/local/bin/edamame_posture
...
1. **Download** the Debian package for your platform:
   - **x86_64 (64-bit):** [edamame-posture_0.9.47-1_amd64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame-posture_0.9.47-1_amd64.deb)
   - **i686 (32-bit):** [edamame-posture_0.9.47-1_i386.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame-posture_0.9.47-1_i386.deb)
   - **aarch64 (ARM 64-bit):** [edamame-posture_0.9.47-1_arm64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame-posture_0.9.47-1_arm64.deb)
   - **armv7 (ARM 32-bit):** [edamame-posture_0.9.47-1_armhf.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame-posture_0.9.47-1_armhf.deb)
...
2. **Install** the package using either method:
   ```bash
   sudo apt install ./edamame-posture_0.9.47-1_amd64.deb
   # or
   sudo dpkg -i edamame-posture_0.9.47-1_amd64.deb
   ```
...
1. **Download Binary**: From the Releases page, download the binary for your architecture:
   - **x86_64 (64-bit)**: [edamame_posture-0.9.47-x86_64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-x86_64-unknown-linux-gnu)  
   - **i686 (32-bit)**: [edamame_posture-0.9.47-i686-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-i686-unknown-linux-gnu)  
   - **aarch64 (ARM 64-bit)**: [edamame_posture-0.9.47-aarch64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-aarch64-unknown-linux-gnu)  
   - **armv7 (ARM 32-bit)**: [edamame_posture-0.9.47-armv7-unknown-linux-gnueabihf](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-armv7-unknown-linux-gnueabihf)
   - **x86_64 (64-bit) for Alpine Linux (musl)**: [edamame_posture-0.9.47-x86_64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-x86_64-unknown-linux-musl) 
   - **aarch64 (ARM 64-bit) for Alpine Linux (musl)**: [edamame_posture-0.9.47-aarch64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-aarch64-unknown-linux-musl)
...
1. **Download** the macOS universal binary:
   - [edamame_posture-0.9.47-universal-apple-darwin](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-universal-apple-darwin)  
...
1. **Download** the Windows binary:
   - [edamame_posture-0.9.47-x86_64-pc-windows-msvc.exe](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v0.9.47/edamame_posture-0.9.47-x86_64-pc-windows-msvc.exe)
