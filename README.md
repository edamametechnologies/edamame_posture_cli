...
1. **Download** the Debian package for your platform:
   - **x86_64 (64-bit):** [edamame-posture_1.3.12-1_amd64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame-posture_1.3.12-1_amd64.deb)
   - **i686 (32-bit):** [edamame-posture_1.3.12-1_i386.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame-posture_1.3.12-1_i386.deb)
   - **aarch64 (ARM 64-bit):** [edamame-posture_1.3.12-1_arm64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame-posture_1.3.12-1_arm64.deb)
     - For Raspberry Pi 3/4/5 running 64-bit OS
   - **armv7 (ARM 32-bit):** [edamame-posture_1.3.12-1_armhf.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame-posture_1.3.12-1_armhf.deb)
...
2. **Install** the package using either method:
   ```bash
   sudo apt install ./edamame-posture_1.3.12-1_amd64.deb
   # or
   sudo dpkg -i edamame-posture_1.3.12-1_amd64.deb
   ```
...
1. **Download Binary**: From the Releases page, download the binary for your architecture:
   - **x86_64 (64-bit)**: [edamame_posture-1.3.12-x86_64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-x86_64-unknown-linux-gnu)
   - **i686 (32-bit)**: [edamame_posture-1.3.12-i686-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-i686-unknown-linux-gnu)
   - **aarch64 (ARM 64-bit)**: [edamame_posture-1.3.12-aarch64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-aarch64-unknown-linux-gnu)
   - **armv7 (ARM 32-bit)**: [edamame_posture-1.3.12-armv7-unknown-linux-gnueabihf](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-armv7-unknown-linux-gnueabihf)
   - **x86_64 (64-bit) for Alpine Linux (musl)**: [edamame_posture-1.3.12-x86_64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-x86_64-unknown-linux-musl)
   - **aarch64 (ARM 64-bit) for Alpine Linux (musl)**: [edamame_posture-1.3.12-aarch64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-aarch64-unknown-linux-musl)
...
```bash
chmod +x edamame_posture-1.3.12-x86_64-unknown-linux-gnu
sudo mv edamame_posture-1.3.12-x86_64-unknown-linux-gnu /usr/local/bin/edamame_posture
```
...
1. **Download** the macOS universal binary:
   - [edamame_posture-1.3.12-universal-apple-darwin](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-universal-apple-darwin)
...
1. **Download** the Windows binary:
   - [edamame_posture-1.3.12-x86_64-pc-windows-msvc.exe](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-x86_64-pc-windows-msvc.exe)
...
jobs:
  verify-security-signature:
    ...
    steps:
      ...
      - name: Install EDAMAME Posture
        run: |
          curl -LO https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.3.12/edamame_posture-1.3.12-x86_64-unknown-linux-gnu
          chmod +x edamame_posture-1.3.12-x86_64-unknown-linux-gnu
          sudo mv edamame_posture-1.3.12-x86_64-unknown-linux-gnu /usr/local/bin/edamame_posture
