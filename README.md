...
- [Release-time Performance and Attack Pattern Detection Reporting](#release-time-performance-and-attack-pattern-detection-reporting)
...
These reads project EDAMAME's durable metrics-history database. They never
call an LLM -- the metrics are computed by the core from per-agent transcripts
and EDAMAME's own provider call telemetry. They back the EDAMAME app's
**Agents -> Behavior** telemetry trends.

```bash
# Durable metrics-history time-series (JSON). FAMILY is optional ('all' = every family).
# Common families: tokens_total_by_agent, est_cost_usd_by_agent, llm_calls_total_by_model,
...
edamame_posture background-metrics-history tokens_total_by_agent --granularity hourly --range-minutes 1440
...
`--range-minutes` (default 1440 = 24h). It emits JSON for piping into `jq` or
CI dashboards.
...
1. **Download** the Debian package for your platform:
   - **x86_64 (64-bit):** [edamame-posture_1.7.0-1_amd64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame-posture_1.7.0-1_amd64.deb)
   - **i686 (32-bit):** [edamame-posture_1.7.0-1_i386.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame-posture_1.7.0-1_i386.deb)
   - **aarch64 (ARM 64-bit):** [edamame-posture_1.7.0-1_arm64.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame-posture_1.7.0-1_arm64.deb)
     - For Raspberry Pi 3/4/5 running 64-bit OS
   - **armv7 (ARM 32-bit):** [edamame-posture_1.7.0-1_armhf.deb](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame-posture_1.7.0-1_armhf.deb)
...
2. **Install** the package using either method:
   ```bash
   sudo apt install ./edamame-posture_1.7.0-1_amd64.deb
   # or
   sudo dpkg -i edamame-posture_1.7.0-1_amd64.deb
   ```
...
1. **Download Binary**: From the Releases page, download the binary for your architecture:
   - **x86_64 (64-bit)**: [edamame_posture-1.7.0-x86_64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-x86_64-unknown-linux-gnu)
   - **i686 (32-bit)**: [edamame_posture-1.7.0-i686-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-i686-unknown-linux-gnu)
   - **aarch64 (ARM 64-bit)**: [edamame_posture-1.7.0-aarch64-unknown-linux-gnu](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-aarch64-unknown-linux-gnu)
   - **armv7 (ARM 32-bit)**: [edamame_posture-1.7.0-armv7-unknown-linux-gnueabihf](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-armv7-unknown-linux-gnueabihf)
   - **x86_64 (64-bit) for Alpine Linux (musl)**: [edamame_posture-1.7.0-x86_64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-x86_64-unknown-linux-musl)
   - **aarch64 (ARM 64-bit) for Alpine Linux (musl)**: [edamame_posture-1.7.0-aarch64-unknown-linux-musl](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-aarch64-unknown-linux-musl)
...
```bash
chmod +x edamame_posture-1.7.0-x86_64-unknown-linux-gnu
sudo mv edamame_posture-1.7.0-x86_64-unknown-linux-gnu /usr/local/bin/edamame_posture
```
...
1. **Download** the macOS universal binary:
   - [edamame_posture-1.7.0-universal-apple-darwin](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-universal-apple-darwin)
...
1. **Download** the Windows binary:
   - [edamame_posture-1.7.0-x86_64-pc-windows-msvc.exe](https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-x86_64-pc-windows-msvc.exe)
...
jobs:
  verify-security-signature:
    ...
    steps:
      ...
      - name: Install EDAMAME Posture
        run: |
          curl -LO https://github.com/edamametechnologies/edamame_posture_cli/releases/download/v1.7.0/edamame_posture-1.7.0-x86_64-unknown-linux-gnu
          chmod +x edamame_posture-1.7.0-x86_64-unknown-linux-gnu
          sudo mv edamame_posture-1.7.0-x86_64-unknown-linux-gnu /usr/local/bin/edamame_posture
...
## Release-time Performance and Attack Pattern Detection Reporting
